...
export const { styled, css, globalCss, keyframes, getCssText, theme, createTheme } = createStitches({
  theme: {
    colors: {
      ...
      glass: "rgba(10,10,15,0.8)", glassBorder: "rgba(99,102,241,0.15)",
    },
    ...
    shadows: { sm:"0 1px 3px rgba(0,0,0,0.3)",md:"0 4px 12px rgba(0,0,0,0.4)",lg:"0 8px 30px rgba(0,0,0,0.5)",glow:"0 0 20px rgba(99,102,241,0.15)" },
...
export const lightTheme = createTheme({
  colors: {
    ...
    glass: "rgba(248,248,252,0.85)", glassBorder: "rgba(99,102,241,0.1)",
  },
})